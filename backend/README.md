...
## Project Structure
    ...
    ├── checksavedchanges_d_26098  # Django project configurations
...
1. Clone this repo and `cd checksavedchanges_d_26098`
...
2. Clone this repo and `cd checksavedchanges_d_26098`
